...
export default function StaffPage() {
  ...
  const unassignedStaff = useMemo(
    () => staff.filter((s) => !s.unitId && !s.teamId),
    [staff],
  );
    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto py-2">
        ...
        <div className="mx-2 mt-2 border-t border-slate-100 pt-2">
          <div className="px-2 py-1 text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-1">
            Unassigned Teams
          </div>
          <div
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>
                {unassignedStaff.length === 0
                  ? "No teams"
                  : `${unassignedStaff.length} staff`}
              </span>
            </div>
          </div>
          {unassignedStaff.length === 0 && (
            <p className="px-2.5 py-1 text-[11px] text-slate-300 italic">
              No teams
            </p>
          )}
        </div>
