  ...
  return (
    <div className="px-4 py-3 border-b border-gray-100 last:border-b-0">
      ...
      {editing ? (
        ...
        <p
          onClick={startEdit}
          className={`text-sm font-semibold cursor-pointer ${value ? "text-gray-800" : "text-gray-300 italic"}`}
        >
          {value || placeholder}
        </p>
      )}
    ...
    return {
      ...
      assessment_period:
        info.periodFrom && info.periodTo
          ...
          : "",
      data: Object.entries(sectionMap).map(([master1, data]) => ({
        master1,
        data,
      })),
    };
      ...
      <div className="bg-emerald-700 text-white px-4 py-3 flex items-center gap-3 sticky top-0 z-20 shadow-md">
        ...
        <div className="flex-1">
          ...
          <p className="text-[11px] opacity-80 mt-0.5">
            {displayVal(info.nameOf3PL, "3PL")} ·{" "}
            {displayVal(info.location, "Location")}
          </p>
        </div>
      </div>
